    ...
    var calendarSwitch = (function() {
        ...
        calendarSwitch.prototype = {
            init: function() {
                ...
                var html = "<div class='headerWrapper'><div class='headerTip'>请选择时间段</div><div class='goback goback_date'>取消</div><div class='comfire comfire_date'>确定</div></div><table class='dateZone'><tr><td class='colo'>日</td><td>一</td><td>二</td><td>三</td><td>四</td><td>五</td><td class='colo'>六</td></tr></table>" + "<div class='tbody'></div>"
            ...
            _initselected: function() {
                ...
                //     $(arry[i]).css({'color':'#ccc','text-decoration':'line-through'});
                // }
